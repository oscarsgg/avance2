                        ...
                        <ul>
                            ...
                            <li>
                                <a href="profile.php">
                                    ...
                                    <span class="text">Ver perfil de administrador</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                        ...
                        <ul>
                            <li class="">
                                <a href="registrar_admin.php">
                                    <i class="icon ph-bold ph-user-circle-plus"></i>
                                    <span class="text">Registrar nuevo admin</span>
                                </a>
                            </li>
                    </div>
                    <div class="menu">
