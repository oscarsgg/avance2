...
<body>
    ...
    <div class="card">
        ...
        <div class="card__subtitle">
            ...
            if ($anios > 0) {
                // Redondear a 1 decimal, pero mostrar solo si no es ".0"
                ...
                <div class="aboutme-item">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="edit-phone" name="phone"
                            value="<?php echo htmlspecialchars($prospecto['numTel']); ?>" required pattern="\d{10}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="edit-summary" name="summary"
                            value="<?php echo htmlspecialchars($prospecto['resumen']); ?>" required>
                    </div>
                </div>
                ...
                <div id="experienceList">
                    <?php foreach ($experiencias as $index => $exp): ?>
                        <div class="experience-item">
                            ...
                            <input type="text" name="puesto[]" value="<?php echo htmlspecialchars($exp['puesto']); ?>"
                                required>
                            ...
                            <input type="date" name="fechaFin[]" value="<?php echo htmlspecialchars($exp['fechaFin']); ?>"
                                required>
