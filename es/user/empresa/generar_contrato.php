...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO Contrato (fechaInicio, fechaCierre, salario, horasDiarias, horario, prospecto, vacante, tipo_contrato, firma_empresa) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    
    $stmt = $conexion->prepare($sql);
    $stmt->bind_param("ssdiisiss", $fecha_inicio, $fecha_cierre, $salario, $horas_diarias, $horario, $prospecto, $vacante, $tipo_contrato, $firma_ruta);
