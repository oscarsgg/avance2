                        ...
                        <ul>
                            ...
                            <li>
                                <a href="perfil_empresa.php">
                                    ...
                                    <span class="text">Ver perfil de empresa</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="publicar_vacante.php">
                                            <span class="text">Publicar vacante</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="gestionar_vacantes.php">
                                            <span class="text">Gestionar vacantes publicadas</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="revisar_solicitudes.php">
                                            <span class="text">Revisar solicitudes</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="membresia.php">
                                    ...
                                    <span class="text">Gestionar membresía</span>
                                </a>
                            </li>
                        </ul>
                    </div>
