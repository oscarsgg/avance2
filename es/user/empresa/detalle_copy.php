...
<div style='display: flex; justify-content: space-between; margin-top: 50px;'>
    <div style='text-align: center;'>
        ...
        <p>Representante de {$contrato['empresa_nombre']}</p>
    </div>
    <div style='text-align: center;'>
        <div style='border-bottom: 1px solid black; width: 200px; height: 50px;'></div>
        <p>{$contrato['prospecto_nombre']} {$contrato['prospecto_primerApellido']} {$contrato['prospecto_segundoApellido']}</p>
    </div>
</div>
";
...
<body>
    ...
    <?php if ($_SESSION['user_role'] === 'EMP' && empty($firma_empresa)): ?>
    <h2>Firma del PATRÓN</h2>
    ...
    <form id="signatureForm" method="POST">
        <input type="hidden" name="firma_empresa" id="firma_empresa">
    </form>
    <?php elseif ($_SESSION['user_role'] === 'PRO' && empty($firma_prospecto)): ?>
