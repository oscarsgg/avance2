...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-10-2024 a las 20:55:43
...
INSERT INTO `contrato` (`numero`, `fechaInicio`, `fechaCierre`, `prospecto`, `vacante`, `tipo_contrato`) VALUES
(1, '2024-04-01', '2024-06-30', 1, 1, 'TC04');
...
INSERT INTO `experiencia` (`numero`, `puesto`, `descripcion`, `nombreEmpresa`, `fechaInicio`, `fechaFin`, `duracionMeses`, `prospecto`) VALUES
(1, 'Desarrollador', 'Desarrollo de aplicaciones web.', 'Tech Solutions', '2021-01-01', '2022-01-01', 12, 1),
(2, 'Analista de Sistemas', 'Análisis de requerimientos y diseño de sistemas.', 'Innovatech', '2020-01-01', '2020-12-31', 12, 1),
(3, 'Gerente de Proyectos', 'Gestión y supervisión de proyectos de IT.', 'Global Tech', '2019-05-01', '2021-05-01', 24, 2),
(4, 'Consultor IT', 'Asesoría en soluciones tecnológicas.', 'Tech Advisors', '2018-01-01', '2019-04-30', 16, 2);
...
INSERT INTO `membresia` (`numero`, `fechaVencimiento`, `estatus`, `empresa`, `plan_suscripcion`) VALUES
(1, '2024-12-31', 1, 1, 'PRO01'),
(2, '2025-06-30', 1, 2, 'PRE01'),
(4, '2024-10-26', 0, 5, 'BAS01');
...
('PRE01', 6, 999.99, 916.66),
('PRO01', 12, 999.99, 833.33);
...
INSERT INTO `prospecto` (`numero`, `nombre`, `primerApellido`, `segundoApellido`, `resumen`, `fechaNacimiento`, `usuario`, `numTel`) VALUES
(1, 'Juan', 'Pérez', 'González', 'Hola', '1990-01-01', 3, '6641234566'),
(2, 'María', 'García', 'Rodríguez', 'Hola', '1992-02-02', 5, '6640678733'),
(3, 'Chanchito', 'Muy', 'Feliz', 'Amante de los chanchitos felices', '2005-12-12', 7, '6645638876'),
(4, 'Chanchito', 'Feliz', 'Garcia', 'hola', '2005-03-20', 8, '6644879993'),
(5, 'Ramses', 'Aguirre', 'Espinoza', 'Heroico en Free Fire', '2005-03-02', 10, '6645768878');
...
(1, 'Experiencia en desarrollo de software con Java y S', 1),
(2, 'Conocimientos de bases de datos relacionales y no ', 1),
(3, 'Experiencia en trabajo en equipo y colaboración co', 1),
(4, 'Experiencia en configuración de routers y switches', 2),
(5, 'Conocimientos de protocolos de red y seguridad', 2),
(6, 'Experiencia en trabajo en equipo y colaboración co', 2),
(7, 'Experiencia en análisis de datos con SQL y Tableau', 3),
(8, 'Conocimientos de estadística y matemáticas', 3),
(9, 'Experiencia en trabajo en equipo y colaboración co', 3),
(10, 'que tengan bueb pene', 4);
...
(4, 'Recopilar y analizar requisitos del cliente.', 2),
(5, 'Documentar procesos y sistemas.', 2),
...
('TC03', 'Contrato por obra o servicio d', 'Contrato para realizar una obra o servicio específico, se termina cuando se completa la obra o servicio'),
...
INSERT INTO `usuario` (`numero`, `correo`, `contrasenia`, `rol`) VALUES
(1, 'admin@gmail.com', '12345', 'ADM'),
(2, 'empresa@gmail.com', '12345', 'EMP'),
(3, 'prospecto@gmail.com', '12345', 'PRO'),
(4, 'empresa2@gmail.com', '12345', 'EMP'),
(5, 'prospecto2@gmail.com', '12345', 'PRO'),
(6, 'ewjfoewjfew@gmail.com', '12345', 'EMP'),
(7, 'chanchito@feliz.com', 'chanchitofeliz', 'PRO'),
(8, 'oscargael.gar7@gmail.com', '12345', 'PRO'),
(9, 'empresa3@gmail.com', '12345', 'EMP'),
(10, 'ramses@gmail.com', '12345', 'PRO');
...
INSERT INTO `vacante` (`numero`, `titulo`, `descripcion`, `salario`, `es_directo`, `cantEmpleados`, `fechaInicio`, `fechaCierre`, `diasRestantes`, `estado`, `tipo_contrato`, `empresa`) VALUES
(1, 'Desarrollador de software', 'Se busca un desarrollador de software con experiencia en Java y Spring Boot para trabajar en un proyecto de desarrollo de software', 50000, 1, 1, '2024-01-01', '2024-01-31', 30, 1, 'TC04', 1),
(2, 'Ingeniero de redes', 'Se busca un ingeniero de redes con experiencia en configuración de routers y switches para trabajar en un proyecto de implementación de redes', 60000, 0, 2, '2024-02-01', '2024-02-28', 28, 1, 'TC03', 2),
(3, 'Analista de datos', 'Se busca un analista de datos con experiencia en SQL y Tableau para trabajar en un proyecto de análisis de datos', 40000, 1, 1, '2024-03-01', '2024-03-31', 31, 1, 'TC02', 1),
(4, 'inspector de testicolus', 'xd', 30000, 1, 44, '2024-10-09', '2024-11-13', 37, 1, 'TC01', 1),
(5, 'Recepcionista de GYM', '1', 0, 1, 12, '2024-10-27', '2024-10-31', 5, 1, 'TC02', 1);
...
--
ALTER TABLE `experiencia`
  MODIFY `numero` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `responsabilidades`
  MODIFY `numero` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
